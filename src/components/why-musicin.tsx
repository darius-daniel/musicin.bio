...
export default function WhyMusicin() {
  const reasons = [
    ...
    },
    {
      ...
      explanation: 'Select from an infinite number of themes and customize them how you like.'
    },
    {
      index: 4,
      title: 'Informative Analytics',
      explanation: 'Our analytics management tool will help you make the best of your audience.'
    }
  ];
